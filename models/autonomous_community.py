...
class autonomous_Community(models.Model):
    _name = 'iracema.autonomous_community'
...
class autonomous_Community_Natural_Park(models.Model):
    _name = 'iracema.autonomous_community_natural_park'

    autonomous_community_id = fields.Many2one('iracema.autonomous_community',
        ondelete='set null', string="Comunidad Autonoma")
    natural_park_id = fields.Many2one('iracema.natural_park',
