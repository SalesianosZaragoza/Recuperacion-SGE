...
class autonomous_Community(models.Model):
    _name = 'app.autonomous_community'
    ...
    autonomous_community_natural_park_ids = fields.One2many(
        'app.autonomous_community_natural_park', 'autonomous_community_id', string="Natural park")

class autonomous_Community_Natural_Park(models.Model):
    _name = 'app.autonomous_community_natural_park'

    autonomous_community_id = fields.Many2one('app.autonomous_community',
        ondelete='set null', string="Comunidad Autonoma")
    natural_park_id = fields.Many2one('app.natural_park',
